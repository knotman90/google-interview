...
/**
 * @brief solveFindDigits: https://www.hackerrank.com/challenges/find-digits
 */
void solveFindDigits(){
    int N; cin>>N;
    while(N--){
        int n; cin>>n;
        int ans=0;
...
/**
 * @brief solveCompareTheTriplets: https://www.hackerrank.com/challenges/compare-the-triplets
 *  
 */
void solveCompareTheTriplets(){
    int a[3];
    int b[3];
    int pa,pb; pa=pb=0;
    loop0n(i,3){
